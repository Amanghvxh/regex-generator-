/*! For license information please see main.89a31f26.js.LICENSE.txt */
!(function () {
  "use strict";
  var e = {
      463: function (e, t, n) {
        ...
        var li = {
          ...
          ui = {
            ...
            useDebugValue: Gl,
            useDeferredValue: function (e) {
              return Yl(Nl(), vl.memoizedState, e);
            },
            useTransition: function () {
        ...
        function _s(e, t, n) {
          ...
          null !== r && r.delete(t),
            ...
            Tu === e &&
              (Lu & n) === n &&
              (4 === ju ||
              (3 === ju && (130023424 & Lu) === Lu && 500 > Xe() - Vu)
                ? ps(e, 0)
                : (Uu |= n)),
            as(e, t);
        }
  ...
  !(function () {
    ...
    var a = function () {
      return (0, r.jsx)("nav", {
        className: "navbar",
        children: (0, r.jsx)("h3", { children: "REGEX BUILDER" }),
      });
    };
    function o(e, t) {
    ...
    function s() {
      ...
      function f(e, t, n, a) {
        var o = t && t.prototype instanceof h ? t : h,
          ...
          i = new N(a || []);
        return r(l, "_invoke", { value: E(e, n, i) }), l;
      }
      function d(e, t, n) {
        try {
      ...
      return (
        ...
        (m.displayName = c(v, i, "GeneratorFunction")),
        ...
        (e.mark = function (e) {
          return (
            Object.setPrototypeOf
              ...
              : ((e.__proto__ = v), c(e, i, "GeneratorFunction")),
    ...
    var j,
      D =
        ((j = "undefined" !== typeof Uint8Array && h(Uint8Array)),
        function (e) {
            ...
            return (
              ...
              i.forEach(function (e, r) {
                !$.isUndefined(e) &&
                  null !== e &&
                  t.append(
                    !0 === l ? ne([n], r, o) : null === l ? n : n + "[]",
                    u(e)
                  );
              }),
              !1
            );
        return !!ee(e) || (t.append(ne(a, n, o), u(e)), !1);
      }
      var c = [],
        f = Object.assign(re, {
          defaultVisitor: s,
              ...
              $.forEach(n, function (n, o) {
                !0 ===
                  (!($.isUndefined(n) || null === n) &&
                    a.call(t, n, $.isString(o) ? o.trim() : o, r, f)) &&
                  e(n, r ? r.concat(o) : [o]);
              }),
              c.pop();
          }
    ...
    var fe = (function () {
      ...
      pe = {
        ...
        classes: {
          URLSearchParams:
            "undefined" !== typeof URLSearchParams ? URLSearchParams : ue,
    ...
    var he = function (e) {
        function t(e, n, r, a) {
          ...
          return (
            ...
            i
              ? ($.hasOwnProp(r, o) ? (r[o] = [r[o], n]) : (r[o] = n), !l)
      ...
      transformRequest: [
        function (e, t) {
          ...
          if ((o && $.isHTMLForm(e) && (e = new FormData(e)), $.isFormData(e)))
            return a && a ? JSON.stringify(he(e)) : e;
          if (
            $.isArrayBuffer(e) ||
            $.isBuffer(e) ||
            $.isStream(e) ||
              ...
              value: function (e, t) {
                if ((e = we(e))) {
                  ...
                  if (n) {
                    ...
                    if ($.isFunction(t)) return t.call(this, r, n);
                    if ($.isRegExp(t)) return t.exec(r);
                    throw new TypeError(
    ...
    $.inherits(Ne, Y, { __CANCEL__: !0 });
    var Pe = Ne;
    var Oe = pe.isStandardBrowserEnv
      ? {
          write: function (e, t, n, r, a, o) {
            var l = [];
            l.push(e + "=" + encodeURIComponent(t)),
              $.isNumber(n) && l.push("expires=" + new Date(n).toGMTString()),
    ...
    var Re = pe.isStandardBrowserEnv
      ? (function () {
          var e,
        ...
        xhr:
          ...
          function (e) {
            return new Promise(function (t, n) {
              ...
              $.isFormData(a) &&
                (pe.isStandardBrowserEnv || pe.isStandardBrowserWebWorkerEnv) &&
                o.setContentType(!1);
    ...
    var De = function (e) {
      for (
        var t, n, r = (e = $.isArray(e) ? e : [e]).length, a = 0;
        a < r && ((t = e[a]), !(n = $.isString(t) ? je[t.toLowerCase()] : t));
        a++
      );
      if (!n) {
        if (!1 === n)
    ...
    function Me(e) {
      return (
        ...
        De(e.adapter || ye.adapter)(e).then(
          function (t) {
            return (
              Ae(e),
    ...
    function Ie(e, t) {
      ...
      var u = {
        ...
        headers: function (e, t) {
          return a(Ue(e), Ue(t), !0);
        },
      };
      return (
        $.forEach(Object.keys(e).concat(Object.keys(t)), function (r) {
          var o = u[r] || a,
            l = o(e[r], t[r], r);
          ($.isUndefined(l) && o !== i) || (n[r] = l);
        }),
        n
      );
    }
        ...
        return (
          K(e, [
            ...
            },
            {
              ...
              value: function (e) {
                return ce(
                  Te((e = Ie(this.defaults, e)).baseURL, e.url),
                  e.params,
                  e.paramsSerializer
                );
              },
      ...
      Ke = (function () {
        function e(t) {
          ...
          this.promise.then(function (e) {
            ...
            t(function (e, t, a) {
              r.reason || ((r.reason = new Pe(e, t, a)), n(r.reason));
            });
        }
        return (
          K(
    ...
    var Xe = (function e(t) {
      var n = new qe(t),
        r = f(qe.prototype.request, n);
      return (
        $.extend(r, qe.prototype, n, { allOwnKeys: !0 }),
    ...
    (Xe.Axios = qe),
      ...
      (Xe.formToJSON = function (e) {
        return he($.isHTMLForm(e) ? new FormData(e) : e);
      }),
      (Xe.HttpStatusCode = Je),
      (Xe.default = Xe);
    var Ye = Xe,
      Ze = (function () {
        var e,
          t =
            ((e = s().mark(function e(t, n, r, a, o) {
              var l, i, u, c, f;
              return s().wrap(
                function (e) {
                  for (;;)
                    switch ((e.prev = e.next)) {
                      case 0:
                        return (
                          ...
                          (i = {
                            chracterToRemove: t,
                            stringToRemoveFrom: n,
                            language: r,
                          }),
                          console.log(i),
                          (e.next = 5),
                          Ye.post("http://localhost:500/api/v1/build", i)
                        );
                      case 5:
                        (u = e.sent),
                          (c = u.data),
                          ...
                          o(!0),
                          console.log(f),
                          a(null !== (l = f[0]) && void 0 !== l ? l : c.data),
                          (e.next = 17);
                        break;
                      case 14:
      ...
      return (0, r.jsxs)("div", {
        ...
        children: [
          (0, r.jsx)("input", {
            ...
            type: "search",
            onKeyUp: function (e) {
              var t = ot(e).map(function (e) {
                return (0,
                r.jsx)("li", { className: "searchResultsList", value: e, children: e });
              });
              o(t);
            },
          }),
    ...
    var it = function () {
      var t = l(e.useState(""), 2),
        ...
        u = o[0],
        s = o[1],
        c = l(e.useState("ECMAScript (JavaScript)"), 2),
        f = c[0],
        d = c[1],
        p = l(e.useState(""), 2),
        h = p[0],
      ...
      return (
        ...
        (0, r.jsxs)("section", {
          ...
          children: [
            (0, r.jsx)("div", { className: "listContainer" }),
            (0, r.jsxs)("div", {
              className: "regex-generator",
              children: [
                (0, r.jsx)(lt, { setState: d }),
                (0, r.jsx)(at, { setState: d, value: f }),
                (0, r.jsx)(i, {
                  name: "Input text",
                  stateValue: a,
    ...
    var ut = function () {
      return (0, r.jsx)("footer", { className: "footer", children: "Footer" });
    };
    var st = function () {
      return (0, r.jsxs)("main", {
        className: "main-container",
        children: [(0, r.jsx)(a, {}), (0, r.jsx)(it, {}), (0, r.jsx)(ut, {})],
      });
    };
    t.createRoot(document.getElementById("root")).render(
      (0, r.jsx)(e.StrictMode, { children: (0, r.jsx)(st, {}) })
    );
  })();
})();
// # sourceMappingURL=main.89a31f26.js.map
